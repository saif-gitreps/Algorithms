...
// atempt2 . still bugs around the code.
...
void kev(int i,vector<int> a,stack<int> &s,unordered_map<int,int> &mp,unordered_map<int,int> &avail){
   if(i>=a.size()){
      return;
   }
   if(s.size()==2){
